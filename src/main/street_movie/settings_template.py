...
FFMPEG_COMMAND = '/path/to/ffmpeg -r %s -i %s/%%05d.jpg -an -vcodec libx264 -s 600x300 -b:v 1m -pix_fmt yuv420p %s'
...
FB_OGP_DESCRIPTION = u'from %s to %s distance is %s speed is %s'
